  ...
  <v-container fluid fill-height v-if="showIntro">
    <v-row align="center" justify="center">
      <v-col class="text-center" cols="12">
        <span :class="mobile ? 'text-h5 font-weight-regular' : 'text-h3 font-weight-light'"><v-icon :style="mobile ? 'font-size: 30px' : 'font-size: 50px'" color="light-green" :class="mobile ? 'pr-3 mb-2' : 'pr-6 mb-2'">mdi-translate</v-icon>Neural Translate</span>
      </v-col>
